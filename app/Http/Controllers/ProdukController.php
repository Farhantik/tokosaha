...
public function logs($id)
{
    try {
        ...
        // Ambil logs tanpa eager loading relationship yang bermasalah
        ...
        $totalPenjualan = ProdukLog::where('id_produk', $id)
            ->where('jenis_aktivitas', 'penjualan')
            ->count();
        $totalPenerimaan = ProdukLog::where('id_produk', $id)
            ->whereIn('jenis_aktivitas', ['penerimaan', 'tambah_stok'])
            ->count();
        $totalStokKeluar = ProdukLog::where('id_produk', $id)
            ->where('jenis_aktivitas', 'kurang_stok')
            ->count();
