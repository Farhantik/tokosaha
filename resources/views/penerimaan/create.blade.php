...
@section('page-title', 'Tambah Penerimaan Barang')
    ...
    @push('scripts')
        <script>
            ...
            function addItem() {
                ...
                const itemHtml = `
        <div class="item-row bg-gray-50 border-2 border-gray-200 rounded-xl p-4" id="item-${itemIndex}" data-index="${itemIndex}">
    ...
    `;
            ...
            document.getElementById('formPenerimaan').addEventListener('submit', function(e) {
                ...
                items.forEach(item => {
                    ...
                    if (selectedProducts.includes(produkId)) {
                        hasDuplicate = true;
                    } else {
                ...
                if (hasDuplicate) {
                    e.preventDefault();
                    alert('⚠️ Ada produk yang sama dipilih lebih dari 1 kali!\nHapus salah satu atau gabungkan qty-nya.');
                    return false;
                }
                ...
                items.forEach((item, idx) => {
                    ...
                    if (!produk) {
                        valid = false;
                        errorMessage = `Item ${idx + 1}: Produk belum dipilih!`;
                    } else if (harga <= 0) {
                        valid = false;
                        errorMessage = `Item ${idx + 1}: Harga harus lebih dari 0!`;
                    } else if (qty <= 0) {
                        valid = false;
                        errorMessage = `Item ${idx + 1}: Qty harus lebih dari 0!`;
                    }
                });
