        ...
        <div class="flex items-center justify-between">
            ...
            @if (auth()->user()->role_user === 'kasir')
                <a href="{{ route('transaksi.index') }}"
                    class="inline-flex items-center px-3 sm:px-4 py-2 bg-gradient-to-r from-gray-500 to-gray-600 hover:from-gray-600 hover:to-gray-700 text-white text-xs sm:text-sm font-semibold rounded-xl shadow-md hover:shadow-lg transition-all transform hover:scale-[1.02] active:scale-[0.98]">
