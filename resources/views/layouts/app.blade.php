        ...
        <aside id="sidebar"
            ...
            <div class="p-4 flex-shrink-0">
                <a href="{{ route('dashboard') }}" class="flex items-center space-x-3">
                    <div class="bg-gradient-to-br from-emerald-500 to-green-600 p-2.5 rounded-xl flex-shrink-0 logo-glow">
                        <i class="fas fa-store text-white text-base"></i>
                    </div>
                    <div>
                        <div class="text-white text-base font-bold leading-tight">Toko Sahabat</div>
            ...
            <div class="flex-shrink-0 p-3 border-t border-green-700">
                <div class="mb-2 flex items-center space-x-2 user-info-compact">
                    ...
                    <div class="flex-1 min-w-0">
                        <div class="text-white text-xs font-semibold truncate user-name">
                            {{ Auth::user()->name }}
                        </div>
                        <div class="text-emerald-300 text-xs truncate user-email">
                            {{ Auth::user()->email }}
                        </div>
                        <div class="mt-1">
                            @if (Auth::user()->isOwner())
                ...
                <form action="{{ route('logout') }}" method="POST">
                    @csrf
                    <button type="submit"
                        class="w-full flex items-center justify-center bg-red-500/10 hover:bg-red-500/20 text-red-400 hover:text-red-300 px-3 py-2 rounded-lg transition text-xs font-medium group">
