    ...
    <div class="max-w-4xl mx-auto space-y-6">
        ...
        <div>
            <h1 class="text-2xl md:text-3xl font-bold text-gray-800">
                <i class="fas fa-user-circle mr-2 text-purple-600"></i>Profil Saya
            </h1>
        ...
        <div class="bg-gradient-to-r from-purple-600 to-blue-600 rounded-2xl shadow-2xl p-8 text-white">
            <div class="flex flex-col md:flex-row items-center md:items-start space-y-4 md:space-y-0 md:space-x-6">
                ...
                @if ($user->gambar_user)
                    ...
                    <div class="w-24 h-24 bg-white/20 backdrop-blur-sm rounded-full items-center justify-center text-4xl font-bold shadow-xl border-4 border-white/30" style="display: none;">
                        {{ strtoupper(substr($user->nama_user, 0, 1)) }}
                    </div>
                @else
                    <div class="w-24 h-24 bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center text-4xl font-bold shadow-xl border-4 border-white/30">
                        {{ strtoupper(substr($user->nama_user, 0, 1)) }}
                    </div>
                @endif
        ...
        <div class="bg-white rounded-2xl shadow-lg p-8">
            <h3 class="text-xl font-bold text-gray-800 mb-6 flex items-center">
                <i class="fas fa-edit mr-2 text-purple-600"></i>Edit Profil
            </h3>
            ...
            <form id="formUpdateProfile" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="pt-4">
                    <button type="submit" id="btnSubmit"
                        class="w-full bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white px-6 py-4 rounded-xl font-semibold shadow-lg transition hover:scale-105">
        ...
        <div class="bg-white rounded-2xl shadow-lg p-6">
            <h3 class="text-xl font-bold text-gray-800 mb-6 flex items-center">
                <i class="fas fa-info-circle mr-2 text-blue-600"></i>Informasi Akun
            </h3>
