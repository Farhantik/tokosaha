                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <div class="flex gap-2">
                                    <button onclick='editProduk(@json($item))'
                                        class="flex-1 bg-gradient-to-r from-yellow-500 to-orange-500 hover:from-yellow-600 hover:to-orange-600 text-white px-3 py-2 rounded-lg text-xs font-semibold transition-all shadow-md hover:shadow-lg transform hover:scale-[1.02] active:scale-[0.98]">
                                    ...
                                    <form action="{{ route('produk.destroy', $item->id_produk) }}" method="POST"
                                        ...
                                        <button type="submit" onclick="return confirm('Yakin hapus produk ini?')"
                                            class="w-full bg-gradient-to-r from-red-500 to-pink-600 hover:from-red-600 hover:to-pink-700 text-white px-3 py-2 rounded-lg text-xs font-semibold transition-all shadow-md hover:shadow-lg transform hover:scale-[1.02] active:scale-[0.98]">
